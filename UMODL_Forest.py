    ...
    def fit(self):
        if self.parallelized:
            ...
            for tree in self.ListOfTrees:
                tree.growTree()
    def predict_parallelized(self,TreeModelAndX):
        TreeModel=TreeModelAndX[0]
        X=TreeModelAndX[1]
        preds=TreeModel.predict(X)
        return preds
    def predict(self, X):
        ListOfPreds=[]
