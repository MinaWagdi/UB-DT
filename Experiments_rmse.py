...
def CalculateRMSE(y_true,uplift,treatment):
    #y_true is the real uplift and uplift is the predictions, treatment variable has no role now
    return math.sqrt((np.square(np.subtract(y_true,uplift).mean())))
...
for train_index, test_index in s:
    ...
    df_train.drop(['RealUplift'],axis=1,inplace=True)
    df_test_RealUplift=df_test['RealUplift'].copy()
    df_test_RealUplift=df_test_RealUplift.reset_index(drop=True)
    df_test.drop(['RealUplift'],axis=1,inplace=True)
...
#     resQini_UMODL_DT_NoGlobal.append(CalculateRMSE( y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    print("UMODL Tree")
    #UMODL Tree
    ...
    resQini_UMODL_DT.append(CalculateRMSE( y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
#     #=====================================================================================================
#     #=====================================================================================================
# #     print("Causal Trees")
...
# #     resQini_CausalTree.append(CalculateRMSE( y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
# #     #=====================================================================================================
# #     #=====================================================================================================
    ...
    resQini_CausalForests.append(CalculateRMSE( y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
#     #=====================================================================================================
#     #=====================================================================================================
...
# #     resQini_XLearnerLR.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
# #     #==================================================================================================================
# #     #=====================================================================================================
    ...
    resQini_XLearnerXgboost.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
#     #==================================================================================================================
#     #=====================================================================================================
# #     print("XLearnerRF")
...
# #     resQini_XLearnerRF.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
...
# #     resQini_RLearnerLR.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
...
# #     #==================================================================================================================
    ...
    resQini_RLearnerXgboost.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
# #     #==================================================================================================================
# #     print("RLearnerRF")
...
# #     resQini_RLearnerRF.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
...
#     UMODL Forest
    ...
    resQini_UMODL_RF.append(CalculateRMSE( y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
# #     #=====================================================================================================
# #     #=====================================================================================================
    ...
    resQini_2M_DT.append(CalculateRMSE( y_true =df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
...
#     resQini_2M_LR.append(CalculateRMSE( y_true =df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
...
#     print("Two Model Approach")
    ...
    resQini_2M_Xgboost.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
...
#     resQini_2M_rfc.append(CalculateRMSE( y_true =df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    ...
    resQini_DR_Xgboost.append(CalculateRMSE( y_true =df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
#     #=====================================================================================================
#     #=====================================================================================================
# #     print("DR_RF")
...
# #     resQini_DR_RF.append(CalculateRMSE( y_true =df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
#    #=====================================================================================================
#     #=====================================================================================================
# #     print("DR_LR")
...
# #     resQini_DR_LR.append(CalculateRMSE( y_true =df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
...
#     #=====================================================================================================
    ...
    resQini_ED_RF.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    print("Chi RF")
    ...
    resQini_Chi_RF.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    print("KL RF")
    ...
    resQini_KL_RF.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    print("CTS RF")
    ...
    resQini_CTS_RF.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    print("ED DT")
    ...
    resQini_ED_DT.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    print("Chi DT")
    ...
    resQini_Chi_DT.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    print("KL DT")
    ...
    resQini_KL_DT.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
    #=====================================================================================================
    #=====================================================================================================
    print("CTS DT")
    ...
    resQini_CTS_DT.append(CalculateRMSE(y_true=df_test_RealUplift, uplift=df_preds['Predictions'],treatment=df_preds['Treatment']))
#     #=====================================================================================================
    #=====================================================================================================
